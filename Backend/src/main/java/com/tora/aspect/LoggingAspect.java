...
public class LoggingAspect {
    ...
    @Around("execution(* com.tora.controller..*(..)) && " +
            "!execution(* com.tora.controller.SystemLogController.*(..)) && " +
            "!execution(* com.tora.controller.TaskLogController.*(..)) && " +
            "!execution(* com.tora.controller.HealthController.*(..)) && " +
            "!execution(* com.tora.controller.SystemHealthController.*(..))")
